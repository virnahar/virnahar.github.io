...
const commands = {
    ...
    whoami() {
        this.echo("Virendra Kumar is a seasoned DevOps Architect with a passion for driving technical evolution and fostering innovation. With humble beginnings as a System Administrator, Virendra's journey reflects a remarkable transformation from traditional system operations to cutting-edge DevOps methodologies.\n\nThroughout his career, Virendra has honed his expertise in system architecture, cloud technologies, and automation, leveraging his deep understanding of both legacy systems and modern cloud infrastructures. From carrying CPUs across office floors to architecting scalable cloud solutions, his journey embodies the adaptability and resilience required in today's ever-changing tech landscape.\n\nCurrently, as a DevOps Architect, Virendra is at the forefront of revolutionizing software development practices. His work focuses on driving cost optimization, harnessing the power of AI for intelligent automation, and building high-performing teams that thrive on innovation.\n\nWith a keen eye for emerging technologies and a commitment to continuous learning, Virendra remains dedicated to pushing the boundaries of what's possible in DevOps. By leveraging tools such as Kubernetes, Docker, Terraform, Jenkins, Azure DevOps, GitHub, GitLab, Bitbucket, Jira, Confluence, Ansible, AWS, Azure, and Databricks, he empowers organizations to achieve greater efficiency, scalability, and resilience in their digital transformation journey.\n\nBeyond technical expertise, Virendra is passionate about creating a culture of collaboration and excellence within his teams. He believes that great teams are the cornerstone of success, and he strives to foster an environment where creativity flourishes and individuals are empowered to reach their full potential.");
    },
    ls(dir = null) {
        if (dir) {
            if (dir.startsWith('~/')) {
