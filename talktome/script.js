...
class ChatUI {
  constructor() {
    this.messages = document.querySelector('.chat-container');
  ...
  setupEventListeners() {
    ...
    this.messages.addEventListener('scroll', () => this.handleScroll());
    console.log('Scroll event listener added to messages:', this.messages);
  }
  ...
  addMessage(role, content) {
    ...
    avatar.innerHTML = role === 'bot' ? `<img src="avatar.gif" alt="Bot Avatar" width="35" height="35" />` : `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>`;
